...
$query_dizimos = "SELECT sum(valor) FROM caixa_igreja WHERE `igreja_id`=".$igreja_id." and `caixa_base_id`=1 and `tipo`='saida' and data LIKE '".$mes_referencia."-%'"; 
...
$query_ofertas = "SELECT sum(valor) FROM caixa_igreja WHERE `igreja_id`=".$igreja_id." and `caixa_base_id`=2 and `tipo`='saida' and data LIKE '".$mes_referencia."-%'"; 
...
$query_missoes = "SELECT sum(valor) FROM caixa_igreja WHERE `igreja_id`=".$igreja_id." and `caixa_base_id`=3 and `tipo`='saida' and data LIKE '".$mes_referencia."-%'"; 
...
$query_construcao = "SELECT sum(valor) FROM caixa_igreja WHERE `igreja_id`=".$igreja_id." and `caixa_base_id`=4 and `tipo`='saida' and data LIKE '".$mes_referencia."-%'"; 
...
$query_ent_especiais = "SELECT sum(valor) FROM caixa_igreja WHERE `igreja_id`=".$igreja_id." and `caixa_base_id`=5 and `tipo`='saida' and data LIKE '".$mes_referencia."-%'"; 
...
$query_outros = "SELECT sum(valor) FROM caixa_igreja WHERE `igreja_id`=".$igreja_id." and `caixa_base_id`=6 and `tipo`='saida' and data LIKE '".$mes_referencia."-%'"; 
...
$query_ebd = "SELECT sum(valor) FROM caixa_departamento WHERE `igreja_id`=".$igreja_id." and `departamento_id`=1 and `tipo`='saida' and data LIKE '".$mes_referencia."-%'"; 
...
$query_feminino = "SELECT sum(valor) FROM caixa_departamento WHERE `igreja_id`=".$igreja_id." and `departamento_id`=8 and `tipo`='saida' and data LIKE '".$mes_referencia."-%'"; 
...
$query_masculino = "SELECT sum(valor) FROM caixa_departamento WHERE `igreja_id`=".$igreja_id." and `departamento_id`=9 and `tipo`='saida' and data LIKE '".$mes_referencia."-%'"; 
...
$query_adolescentes = "SELECT sum(valor) FROM caixa_departamento WHERE `igreja_id`=".$igreja_id." and `departamento_id`=10 and `tipo`='saida' and data LIKE '".$mes_referencia."-%'"; 
...
$query_jovens = "SELECT sum(valor) FROM caixa_departamento WHERE `igreja_id`=".$igreja_id." and `departamento_id`=11 and `tipo`='saida' and data LIKE '".$mes_referencia."-%'"; 
...
$query_departamento_infantil = "SELECT sum(valor) FROM caixa_departamento WHERE `igreja_id`=".$igreja_id." and `departamento_id`=12 and `tipo`='saida' and data LIKE '".$mes_referencia."-%'"; 
...
$query_departamento_missoes = "SELECT sum(valor) FROM caixa_departamento WHERE `igreja_id`=".$igreja_id." and `departamento_id`=13 and `tipo`='saida' and data LIKE '".$mes_referencia."-%'"; 
                  ...
                  <div class="widget">
					 ...
					 <div class="clearfix">
                        ...
                        <table class="table table-striped table-bordered dataTable" id="sample_1" aria-describedby="sample_1_info">
                           ...
                           <tbody>
						   <?php
						   $query_saidas = mysqli_query($conecta,"SELECT * FROM caixa_igreja WHERE `igreja_id`=".$igreja_id." and `tipo`='saida' and data LIKE '".$mes_referencia."-%' ORDER BY data");
...
$sql_mov_financeira=mysqli_query($conecta,"select * from caixa_base")or die(mysqli_error($conecta));
	...
	$inserir = mysqli_query($conecta,"INSERT INTO `caixa_igreja`( `caixa_base_id`, `igreja_id`, `data`, `valor`, `tipo`, `status`) VALUES (".$caixa_base_id.",".$igreja_id.",'".$data_lancamento."','".$valor."','saida','".$status_lancamento."')") or die (mysqli_error($conecta));

						echo"<script language=javascript>alert('Saida cadastrada com Sucesso!')</script>";
echo"<script language=javascript>location.href='index.php?view=finandespesas&mes=".$mes."&ano=".$ano."'</script>";
