...
$data_nasc=anti_injection($_POST["data_nasc"]);
								...
								if(empty($cpf)){
echo"<script language=javascript>alert('O Campo CPF é necessário!')</script>";
								
								}else if(empty($teste)){
echo"<script language=javascript>alert('O Campo Nome é necessário!')</script>";
								
								}else if(empty($telefone)){
echo"<script language=javascript>alert('O Campo Telefone é necessário!')</script>";
