...
<li><a href="index.php?view=finanreceitas">Receitas</a><span class="divider">&nbsp;</span></li>
<li><span class="tools">
                           
                         <a href="index.php?view=finanreceitas&mes=<?php echo $mes-1; ?>&ano=<?php echo $ano;?>"> <button class="btn btn-small btn" type="button"><i class="icon-circle-arrow-left"></i></button></a>
                                <button class="btn btn-small btn" type="button"><?php echo mesextenco($mes).' de '.$ano; ?></button>
                               <a href="index.php?view=finanreceitas&mes=<?php echo $mes+1; ?>&ano=<?php echo $ano;?>"> <button class="btn btn-small btn" type="button"><i class="icon-circle-arrow-right"></i></button></a>
                            </span></li>
						</ul>	
				 ...
				 <div data-desktop="span2" data-tablet="span4" class="span2 responsive">
                        ...
                        <div data-desktop="span2" data-tablet="span4" class="span2 responsive">
                            <div class="metro-overview blue-color clearfix">
                                ...
                                <div class="details">
                                    <div class="numbers"><center><?php echo"R$ ".transf_real($entradas_mes_construcao);?></center></div>
                        ...
                        <div data-desktop="span2" data-tablet="span4" class="span2 responsive">
                            <div class="metro-overview red-color clearfix">
                                ...
                                <div class="details">
                                    <div class="numbers"><center><?php echo"R$ ".transf_real($entradas_mes_ent_especiais);?></center></div>
                        ...
                        <div data-desktop="span2" data-tablet="span4" class="span2 responsive">
                            <div class="metro-overview gray-color clearfix">
                                ...
                                <div class="details">
                                    <div class="numbers"><center><?php echo"R$ ".transf_real($entradas_mes_outros);?></center></div>
                  ...
                  <div class="widget">
					 ...
					 <div class="clearfix">
                        ...
                        <table class="table table-striped table-bordered dataTable" id="sample_1" aria-describedby="sample_1_info">
                           ...
                           <tbody>
						   <?php
						   $query_entradas = mysqli_query($conecta,"SELECT * FROM caixa_igreja WHERE `igreja_id`=".$igreja_id." and `tipo`='entrada' and data LIKE '".$mes_referencia."-%' ORDER BY data");
while($result_entradas = mysqli_fetch_assoc($query_entradas)){
		    
		    $tipobusca = mysqli_query($conecta,"SELECT * FROM caixa_base where id=".$result_entradas["caixa_base_id"]);
$resultadotipo = mysqli_fetch_array($tipobusca);
	$tipo_entrada=utf8_encode($resultadotipo["descricao"]);
?>
                              <tr>
                                 <td class="highlight">
                                 ...
                                 <td class="hidden-phone"> <?php echo $tipo_entrada;?></td>
...
?>            
			   ...
			   <div id="myModal1" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true" style="display: none;">
										...
										<form enctype="multipart/form-data" action="index.php?view=finanreceitas&mes=<?php echo $mes;?>&ano=<?php echo $ano;?>"	method="post" >
...
$sql_mov_financeira=mysqli_query($conecta,"select * from caixa_base")or die(mysqli_error($conecta));
	...
	$inserir = mysqli_query($conecta,"INSERT INTO `caixa_igreja`( `caixa_base_id`, `igreja_id`, `data`, `valor`, `tipo`) VALUES (".$caixa_base_id.",".$igreja_id.",'".$data_lancamento."','".$valor."','Entrada')") or die (mysqli_error($conecta));

						echo"<script language=javascript>alert('Receita cadastrada com Sucesso!')</script>";
echo"<script language=javascript>location.href='index.php?view=finanreceitas&mes=".$mes."&ano=".$ano."'</script>";
