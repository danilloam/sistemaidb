...
if($estadoconsulta==""){
	$jsonpessoas = file_get_contents("https://sistemaidb.com.br/sistema/consulta.php?opcao=evangelistas&valor=".$regiao_id);
	$pessoas= json_decode($jsonpessoas);
	$totalpessoas = count($pessoas);
	
}else{
    	$jsonpessoas = file_get_contents("https://sistemaidb.com.br/sistema/consulta.php?opcao=evangelistasestado&valor=".$estadoconsulta);
	$pessoas= json_decode($jsonpessoas);
	$totalpessoas = count($pessoas);
}	
					...
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								...
								<li class="breadcrumb-item active" aria-current="page">Evangelistas</li>
							</ol>
						</nav>
					</div>
					<div class="ms-auto">
