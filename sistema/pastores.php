...
if($estadoconsulta==""){
	$jsonpessoas = file_get_contents("https://sistemaidb.com.br/sistema/consulta.php?opcao=pastores&valor=".$regiao_id);
	$pessoas= json_decode($jsonpessoas);
	$totalpessoas = count($pessoas);
}else{
    	$jsonpessoas = file_get_contents("https://sistemaidb.com.br/sistema/consulta.php?opcao=pastoresestado&valor=".$estadoconsulta);
	$pessoas= json_decode($jsonpessoas);
	$totalpessoas = count($pessoas);
}
?>
							...
							<th class="hidden-phone" style="width:20px;">
                             ...
                             <tbody>
                                 ...
                                 while ($i<$totalpessoas){
                                  ...
                                  <td>".strtoupper($pessoas[$i]->nome)."</td>
                                  <td>";
...
if($pessoas[$i]->celular1<>""){
													 echo  $pessoas[$i]->celular1;
													}
													if($pessoas[$i]->celular2<>""){
													 echo  " / ".$pessoas[$i]->celular2;
													}
																										if($pessoas[$i]->telefone<>""){
													 echo  " / ".$pessoas[$i]->telefone;
													}
 
                                  echo "</td>
                                  <td>".strtoupper($pessoas[$i]->funcao)."</td>
                                   <td>".strtoupper($pessoas[$i]->uf)."</td>
 <center><td><a href='visualizarpessoa.php?ig=".$igreja_id."&id=".$pessoas[$i]->id."' class='various' data-fancybox-type='iframe'><button class='btn btn-primary'><svg xmlns='http://www.w3.org/2000/svg' width='24' height='24' viewBox='0 0 24 24' fill='none' stroke='currentColor' stroke-width='2' stroke-linecap='round' stroke-linejoin='round' class='feather feather-eye'><path d='M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z'></path><circle cx='12' cy='12' r='3'></circle></svg></button></a></td></center>
                                  </tr>"  ;
