...
container.data('hidethumbs',setTimeout(function(){bullets.cssAnimate({'opacity':1},{duration:200,queue:false});ca.animate({'opacity':1},{duration:200,queue:false});},opt.hideThumbs));});}
