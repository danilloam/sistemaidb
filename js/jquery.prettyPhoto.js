...
(function($) {
	...
	$.fn.prettyPhoto = function(pp_settings) {
		pp_settings = jQuery.extend({
			...
			quicktime_markup: '<object classid="clsid:02BF25D5-8C17-4B23-BC80-D3488ABDDC6B" codebase="../../www.apple.com/qtactivex/qtplugin.cab/" height="{height}" width="{width}"><param name="src" value="{path}"><param name="autoplay" value="{autoplay}"><param name="type" value="video/quicktime"><embed src="{path}" height="{height}" width="{width}" autoplay="{autoplay}" type="video/quicktime" pluginspage="../../www.apple.com/www.apple.com/quicktime/download/default.htm"></embed></object>',
			...
			$pp_pic_holder.fadeIn(function(){
				...
				switch(_getFileType(pp_images[set_position])){
					...
					case 'youtube':
						...
						if(settings.autoplay) movie += "../../www.apple.com/qtactivex/qtplugin.cab/_40autoplay=1";
					...
					case 'vimeo':
						...
						movie = '../../player.vimeo.com/video/'+ match[2] +'_40title=0&byline=0&portrait=0';
